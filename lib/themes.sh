...
# Status right
set -g status-right "#[fg=${THEME_SELECTION},bg=${THEME_BG}]${THEME_SEP_RIGHT}#[fg=${THEME_FG},bg=${THEME_SELECTION}] ${THEME_ICON_TIME} %H:%M #[fg=${THEME_ACCENT},bg=${THEME_SELECTION}]${THEME_SEP_RIGHT}#[fg=${THEME_BG},bg=${THEME_ACCENT}] %d-%b "
